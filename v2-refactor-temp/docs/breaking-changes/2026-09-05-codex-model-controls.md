---
title: GPT-6 Astra and updated Codex model controls
category: changed
severity: notice
...
Model checks and text-generation utilities work through Codex's required streaming transport.
...
Select GPT-6 Astra in OpenAI Codex to use it. Existing model settings update automatically.
